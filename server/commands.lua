...
ESX.RegisterCommand('heal', 'admin', function(xPlayer, args, showError)
	TriggerClientEvent('esx_ambulancejob:heal', args.playerId.source)
	TriggerClientEvent('esx_basicneeds:healPlayer', args.playerId.source)
	 local data = {
		 type = "success",
		 title = "¡Hecho!",
		 text = "Se ha enviado la actualización al jugador.",
		 length = 4000,
		 style = {}
	 }
	-- xPlayer.sendAlert(data)
end, false, {help = 'Cura y restablece los valores del metabolismo del jugador.', validate = false, arguments = {
 {name = 'playerId', help = 'Id de jugador destino', type = 'player'}
}})
